...
var defaultPaletteStandardCases = []struct {
	idx      int
	expected color.RGBA
}{
...
func TestDefaultPalette(t *testing.T) {
	t.Run("standard colors", func(t *testing.T) {
		for _, c := range defaultPaletteStandardCases {
	...
	t.Run("color cube", func(t *testing.T) {
		for r := 0; r < 6; r++ {
			for g := 0; g < 6; g++ {
				for b := 0; b < 6; b++ {
					idx := 16 + r*36 + g*6 + b
...
func TestResolveDefaultColor(t *testing.T) {
	...
	t.Run("NRGBA fallback", func(t *testing.T) {
	...
	t.Run("indexed out of range", func(t *testing.T) {
...
func TestResolveDefaultColorNamed(t *testing.T) {
	t.Run("named", func(t *testing.T) {
		for _, c := range namedColorCases {
	...
	t.Run("named dim", func(t *testing.T) {
	...
	t.Run("named out of range", func(t *testing.T) {
